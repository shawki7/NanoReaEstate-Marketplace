...
contract Ownable {
    ...
    event OwnershipTransferred(address oldOwner, address newOwner);
     ...
     modifier onlyOwner(){
        require(msg.sender == _owner, "Sorry, just the owner of the contract is allowed");
        _;
    }

     modifier isAccountNormal (address _address){
        require(Address.isContract(_address) == false, "Account shall be normal");
        _;
    }

    function transferOwnership(address newOwner) public onlyOwner isAccountNormal(newOwner) {
...
contract Pausable is Ownable {
    ...
    bool _paused;
    event Pause(address _sender);
    event Unpause(address _sender);
    ...
    modifier isNotPaused(){
        require(_paused == false, "The contract shall be not paused");
        _;
    }

    modifier isPaused(){
        require(_paused == true, "The contract shall be paused");
        _;
    }

    function setPaused(bool _isPaused)
    onlyOwner
    public
    {
        _paused = _isPaused;
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != msgSender, "OMG you want to approve for your self");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
         require(msg.sender == msgSender || isApprovedForAll(msgSender, msg.sender) == true, "token owner must approve it");
        // TODO add 'to' address to token approvals
         _tokenApprovals[tokenId] = to;
        // TODO emit Approval Event
        emit Approval(msgSender, to, tokenId);
    }
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(_exists(tokenId) != true, "it's already exists");
        require(to != address(0), "address should not be null");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(to != address(0), "you can't send address 0");
        // TODO: clear approval
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function setTokenURIToTokenId(uint tokenId) internal
    {
