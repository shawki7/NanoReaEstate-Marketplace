...
contract('verifier', accounts => {
    ...
    describe('Test verification with correct proof', function () {
        ...
        it('correct proof', async function () {
            let result = await this.contract.verifyTx.call(file.proof.a, file.proof.b, file.proof.c, file.inputs);
    ...
    describe('Test verification with incorrect proof', function () {
        ...
        it('incorrect proof', async function () {
            ...
            let result = await this.contract.verifyTx.call(
                unValidProof.proof.a, unValidProof.proof.b, unValidProof.proof.c, unValidProof.inputs)
            assert.equal(result, false, "proof is unvalid")
